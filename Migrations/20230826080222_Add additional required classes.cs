        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SalesPersonID = table.Column<string>(type: "varchar(10)", nullable: true),
                    CompanyName = table.Column<string>(type: "varchar(50)", nullable: true),
                    Salutation = table.Column<string>(type: "varchar(10)", nullable: true),
                    FirstName = table.Column<string>(type: "varchar(50)", nullable: true),
                    LastName = table.Column<string>(type: "varchar(50)", nullable: true),
                    HomeNo = table.Column<string>(type: "varchar(50)", nullable: true),
                    OfficeNo = table.Column<string>(type: "varchar(50)", nullable: true),
                    ...
                    B_Salutation = table.Column<string>(type: "varchar(10)", nullable: true),
                    B_FirstName = table.Column<string>(type: "varchar(50)", nullable: true),
                    B_LastName = table.Column<string>(type: "varchar(50)", nullable: true),
                    B_Address1 = table.Column<string>(type: "varchar(50)", nullable: true),
                    B_Address2 = table.Column<string>(type: "varchar(50)", nullable: true),
                    B_PostalCode = table.Column<string>(type: "varchar(50)", nullable: true),
                    B_HomeNo = table.Column<string>(type: "varchar(255)", nullable: true),
                    B_MobileNo = table.Column<string>(type: "varchar(255)", nullable: true),
                    B_OfficeNo = table.Column<string>(type: "varchar(50)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime", nullable: true),
                    CreatedBy = table.Column<string>(type: "varchar(50)", nullable: true),
                    LastUpdateDate = table.Column<DateTime>(type: "datetime", nullable: true),
                    LastUpdateBy = table.Column<string>(type: "varchar(50)", nullable: true),
                    ...
                    B_ContactNo = table.Column<string>(type: "varchar(50)", nullable: true),
